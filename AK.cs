...
namespace Lab04_05
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            if (a != 0)
            {
                var r = Sqr(a, b, c, out double x1, out double x2);
                if (x1 == 0 && x2 == 0)
                {
        ...
        public static (double, double) Sqr(double a, double b, double c, out double x1, out double x2)
        {
            double r = 0;
            ...
            var result = (x1, x2); return result;
        }
    }
}
